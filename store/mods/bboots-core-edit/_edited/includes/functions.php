...
'USER_AVATAR'   => ($user->data['user_avatar']) ? get_user_avatar($user->data['user_avatar'],$user->data['user_avatar_type'], ($user->data['user_avatar_width'] > $user->data['user_avatar_height']) ? 22 : round((22 / $user->data['user_avatar_height']) * $user->data['user_avatar_width']), ($user->data['user_avatar_height'] > $user->data['user_avatar_width']) ? 22 : round((22 / $user->data['user_avatar_width']) * $user->data['user_avatar_height'])) : '<i class="icon-picture"></i>',
	...
	/* Begin Extended UCP Menu Functions for bboots */
    ...
    /* Begin Extended UCP Menu Functions for boots */
