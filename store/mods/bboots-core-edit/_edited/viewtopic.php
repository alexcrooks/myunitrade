...
'S_TOPIC_MOD' 			=> ($topic_mod != '') ? '<select class="selectpicker" data-container="body" name="action" id="quick-mod-select">' . $topic_mod . '</select>' : '',
...
'BOOKMARK_CLASS'        => ($user->data['is_registered'] && $config['allow_bookmarks'] && $topic_data['bookmarked']) ? 'icon-bookmark-empty' : 'icon-bookmark',
